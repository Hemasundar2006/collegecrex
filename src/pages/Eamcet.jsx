    ...
    <div className="pt-24 min-h-screen gradient-bg flex items-center justify-center px-4">
        ...
        >
            ...
            <p className="text-primary-700 leading-relaxed mb-10 text-lg">
                We are currently training our AI model with the latest 2025 cutoff data! This feature will be live very soon to help you with your counseling.
            </p>
...
const Eamcet = () => <ComingSoon title="AP EAMCET" />;
